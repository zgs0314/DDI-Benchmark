...
class DataLoader:
    ...
    def load_ent_id(self, ):
        id2entity = dict()
        id2relation = dict()
        drug_set = json.load(open('data/drugbank/node2id_em.json', 'r'))
        entity_set = json.load(open('data/drugbank/entity_drug.json', 'r'))
        relation_set = json.load(open('data/drugbank/relation2id_em.json', 'r'))
    ...
    def process_files_kg(self, kg_paths, saved_relation2id=None, ratio=1):
        ...
        for file_type, file_path in kg_paths.items():
            with open(file_path) as f:
                ...
                for triplet in file_data:
                    h, t, r = int(triplet[0]), int(triplet[1]), int(triplet[2]) + 86
