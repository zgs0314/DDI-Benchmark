...
def run_knowddi(args, file_name, save_path):
    ...
    # parser.add_argument("--gpu", type=int, default=7, help="Which GPU to use?")
    parser.add_argument('--disable_cuda', action='store_true', help='Disable CUDA')
    parser.add_argument('--load_model', action='store_true', help='Load existing model?')
    parser.add_argument("--experiment_name", "-e", type=str, default="Drugbank", help="A folder with this name would be created to dump saved models and log files")

    # dataset
    # parser.add_argument('--dataset', "-d", type=str, default='drugbank') ### drugbank_new, twosides, BioSNAP
    ...
    parser.add_argument('--BKG_file_name', type=str, default='relations_2hop') 
    ...
    # trainer
    parser.add_argument("--eval_every_iter", type=int, default=526, help="Interval of iterations to evaluate the model") ### 526
    ...
    parser.add_argument("--num_epochs", "-ne", type=int, default=100,help="numer of epochs") ### 50
